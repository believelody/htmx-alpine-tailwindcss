...
exports.postsTitle = 'Posts with select pagination';
router.get("/", middlewares_1.default.http.limitQueryValidator, (req, res, next) => utils_1.default.error.handleHttpError(req, next, () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { posts, total } = yield services_1.default.post.fetchAll(limit, limit * (page - 1), "/posts-1");
    return res.render("pages/posts-1", Object.assign(Object.assign({}, req.ctx), { posts, meta: { pages: Math.round(total / limit), page, limit, total }, title: exports.postsTitle }));
})));
router.get('/:id', middlewares_1.default.http.numericParamsValidator, (req, res, next) => utils_1.default.error.handleHttpError(req, next, () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res.render('pages/posts-1/id', Object.assign(Object.assign({}, req.ctx), { post: Object.assign(Object.assign({}, post), { liked, reactions: liked ? ++post.reactions : post.reactions, url: {
                back: utils_1.default.url.retrieveAppropriateBackUrl(req.headers['hx-current-url'], '/posts-1'),
